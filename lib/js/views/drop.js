...
DropItApp.DropView = Backbone.View.extend({
    ...
    initialize: function ( args ) {
        ...
        //this.$el.attributes ={ 'data-col': this.model.column, 'data-row': this.model.row, 'data-sizex': 3  };
    },
    //attributes: { 'data-col': this.model.column },
    tagName: 'div',
    className: 'drop-item',
    events: {
    ...
    render: function() {
        ...
        this.$el
            .attr('data-sizey', '1')
            .attr('data-sizex', this.model.attributes.width )
            .attr( 'data-col', this.model.attributes.column )
            .attr( 'data-row', this.model.attributes.row )
            .html( html );
        //console.log( DropItApp.gridster );
        return this;
    }
});
