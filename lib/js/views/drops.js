...
DropIt.DropsView = Backbone.View.extend({
    ...
    renderDrop: function( item, options ) {
        ...
        // Since we don't save template type in drop meta we need to set drop type template for the model
        var dropType = DropIt.Admin.drop_types[item.attributes.type];
        item.attributes.template = dropType.template;
